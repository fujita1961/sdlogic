 ...
 *
 */
public class TwoSamePointFertility extends Fertility {
...
//		Capacity.setCapacity(Term.FISH, fishCapacity);
	 ...
	 */
	public TwoSamePointFertility(double peak, double field, double radiusOut, double radiusIn) {
		this.peak = peak;
		this.field = field;
