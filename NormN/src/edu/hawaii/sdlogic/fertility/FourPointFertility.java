 ...
 *
 */
public class FourPointFertility extends Fertility {
...
//		Capacity.setCapacity(Term.FISH, fishCapacity);
	 ...
	 */
	public FourPointFertility(double peak, double field, double radiusOut, double radiusIn, boolean right) {
		this.peak = peak;
		this.field = field;
