...
import edu.hawaii.sdlogic.fertility.TwoSamePointFertility;
import edu.hawaii.sdlogic.output.CooperativeCalculateOutput;
import edu.hawaii.sdlogic.output.SimpleCalculateOutput;

public class TwoSamePointInitializer extends Initializer {
	/**
	 * circle radius
	 */
	private int radius;
	 ...
	 * @param radius
	 */
	public TwoSamePointInitializer(int radius) {
		this.radius = radius;
	}

	public TwoSamePointInitializer() {
		this(5);
	}
	...
	protected static void initFertilityAndOutputFunction() {
		...
		if(Env.fertilityClasses == null) {
			...
			Fertility fertility = new TwoSamePointFertility(3, 1, 10, 5);
