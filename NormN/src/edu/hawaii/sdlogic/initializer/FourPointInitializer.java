...
public class FourPointInitializer extends Initializer {
	 ...
	 * @param radius
	 */
	public FourPointInitializer(int radius) {
		this.radius = radius;
	}

	public FourPointInitializer() {
		this(5);
	}
	...
	protected static void initFertilityAndOutputFunction() {
		...
		if(Env.fertilityClasses == null) {
			...
			Fertility fertilityRight = new FourPointFertility(3, 1, 10, 5, true);
			Fertility fertilityLeft = new FourPointFertility(3, 1, 10, 5, false);
	...
	public void init() {
		...
		initPoint(Env.mapWidth / 4, Env.mapHeight / 4);
		initPoint(Env.mapWidth / 4, Env.mapHeight * 3 / 4);
		initPoint(Env.mapWidth * 3 / 4, Env.mapHeight / 4);
		initPoint(Env.mapWidth * 3 / 4, Env.mapHeight * 3 / 4);
